import friendsPageReducer, {ADD_FRIEND, CLOSE_MODAL, DELETE_FRIEND, OPEN_MODAL} from "./friendsPageReducer";
// import {v1} from "uuid";
//
...
//     uId: startState.cardFriends[0].id,
//   }
//   const endState = friendsPageReducer(startState, {type: CLOSE_MODAL, uId: startState.cardFriends[1].id})
//   expect(endState.cardFriends[1].sendMessageStatus).toBe(true)
// })