  ...
  return (
    <div className={classes.mypost}>
      <div className={classes.news__feed}>
        ...
        <AddMessageInPostFormRedux onSubmit={onSubmit}/>
      </div>
      {NewMessagesData}
    </div>
  )
...
const AddMessageInPostForm = (props: any) => {
  return (
    <form onSubmit={props.handleSubmit}>
      <div className={classes.group}>
        <Field name="message" placeholder="Write something here..." component="textarea" type="text"
...
const AddMessageInPostFormRedux = reduxForm({form: 'addMessageInPost'})(AddMessageInPostForm);
